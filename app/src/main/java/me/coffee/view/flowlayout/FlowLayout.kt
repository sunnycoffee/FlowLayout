...
class FlowLayout @JvmOverloads constructor(
    ...
    private var mToggleView: CheckBox? = null
    ...
    init {
        ...
        typedArray.getDrawable(R.styleable.FlowLayout_toggleDrawable)?.let {
            mToggleView = CheckBox(context).apply {
                layoutParams = generateLayoutParams(attrs).apply {
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        mToggleView
            ?.takeIf { mAllLineViews.sumBy { it.size } < mAllViews.size }
